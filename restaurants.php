            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="index.php">Explore Murni Fried Chicken</a></li>
									      ...
									      while($rows=mysqli_fetch_array($ress))
										  {
													 ...
													 echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															<div class="entry-logo">
																<a class="img-fluid" href="dishes.php?cat_id='.$rows['c_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Food logo"></a>
															</div>
															<!-- end:Logo -->
															<div class="entry-dscr">
																<h5><a href="dishes.php?cat_id='.$rows['c_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['description'].'</span>
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<a href="dishes.php?cat_id='.$rows['c_id'].'" class="btn theme-btn-dash">View Menu</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
										  }
