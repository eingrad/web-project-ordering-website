...
<!-- ------------------------------------------------------------------------------- -->
         ...
         <section class="hero bg-image" data-image-src="images/img/main2.png">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Explore Murni</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>We Deliver</h4> </div>
                    </div>
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="dishes.php?cat_id='.$r['c_id'].'">'.$r['title'].'</a></h5>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Explore Murni Fried Chicken</h3>
                                    <p>Explore our restaurant that dedicated to satisfy your appetite.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a dish</h3>
                                <p>We"ve got your covered with a variety of dishes in our menu.</p>
                            </div>
                        </div>
...
<!-- ------------------------------------------------------------------------------- -->
  ...
  <footer style="background-color: #131A25;">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      ...
      <a class="text-dark" href="index.php">MurniFriedChicken.com</a>
    </div>
  </footer>
