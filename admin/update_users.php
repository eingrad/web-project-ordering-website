...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update users set username='$_POST[uname]', f_name='$_POST[fname]', l_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',password='$password' where u_id='$_GET[user_upd]' ";
	mysqli_query($db, $mql);
